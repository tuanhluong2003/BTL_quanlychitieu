...
import com.example.myapplicationandroid.adapter.LoaiChiRAdapter;
import com.example.myapplicationandroid.dialog.LoaiChiCTDialog;
...
public class FragmentLoaiChi extends Fragment {
    ...
    private LoaiChiRAdapter mAdapter;
    ...
    public FragmentLoaiChiViewModel getViewModel() {
        return mViewModel;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new LoaiChiRAdapter(getActivity());
        mRv.setLayoutManager(new LinearLayoutManager(getActivity()));
        mRv.setAdapter(mAdapter);
        final FragmentLoaiChi currentFragment = this;
        ...
        mAdapter.setOnItemViewClickListener(new ItemClickListener() {
            ...
            public void onItemClick(int position) {
                LoaiChi loaiChi= mAdapter.getItem(position);
                LoaiChiCTDialog dialog = new LoaiChiCTDialog(getActivity(),currentFragment,loaiChi);
                dialog.show();
            }
        });
